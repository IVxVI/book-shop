...
export default function LoginPage() {
  ...
  const gitHubAuth = async (event: React.FormEvent) => {
    event.preventDefault();
          ...
          <form className="space-y-6" action="#" method="POST" onSubmit={loginUser}>
            ...
            <div className='flex flex-col gap-3'>
              ...
              <div className="flex justify-center items-center gap-3">
                <button onClick={gitHubAuth} type="button" className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mb-2">
